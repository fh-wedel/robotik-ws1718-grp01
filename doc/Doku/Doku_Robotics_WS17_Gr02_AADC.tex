...
\begin{figure}
	\subfigure[Viel Licht]{\includegraphics[width=0.49\textwidth]{Bilder/line_filt_vielLicht.png}}
	\subfigure[Wenig Licht]{\includegraphics[width=0.49\textwidth]{Bilder/line_filt_wenigLicht.png}}
	\caption{Gefilterte Linienerkennung - verschiedene Lichtverhältnisse}
...
\begin{figure}
	...
	\caption{Gefilterte Linienerkennung - besondere Störeinflüsse und Umstände}
	\label{img:line_filt_reflektion_u_engeKurve}
\end{figure}
...
Die Hauptaufgaben der Motorsteuerung sind das Reagieren auf Flags, wie beispielsweise das Emergencybreak-Flag, sowie die Motorsteuerungsdaten, welche sie von dem Controller bekommt und an die Arduino-Kommunikation weitersendet.
