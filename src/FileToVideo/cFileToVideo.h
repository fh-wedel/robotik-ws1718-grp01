#ifndef _FILETOVIDEO_H_
#define _FILETOVIDEO_H_
...
#define OID_ADTF_FILETOVIDEO "adtf.example.fileToVideo"

class cFileToVideo : public adtf::cFilter {
    ADTF_FILTER(OID_ADTF_FILETOVIDEO, "FileToVideo", adtf::OBJCAT_DataFilter);
...
public:
    cFileToVideo(const tChar* __info);
    virtual ~cFileToVideo();
